<template>
  <header class="px-4 -mx-4 pb-4">
    <div class="max-w-3xl mx-auto flex gap-4 items-center justify-between font-bold relative">
      <div class="flex-1 flex items-center gap-6">
        ...
        >
          <div class="flex-1 bg-white shadow md:shadow-none flex items-center gap-3 dark:bg-neutral-800 dark:border-stone-800 p-4 md:p-0 border md:border-none">
            <div class="flex flex-col md:flex-row gap-4 font-bold text-gray-400 dark:text-gray-500">
              ...
              <nuxt-link to="/upcoming" class="flex items-center gap-2 fill-gray-400 dark:fill-gray-500">
                <icon name="clock"/>
                <span>Upcoming</span>
              </nuxt-link>
            </div>
      ...
      <div class="flex-1 flex gap-4 justify-end text-gray-400 dark:text-gray-500">
        <nuxt-link to="/earn" class="flex items-center items-center gap-2 fill-gray-400 dark:fill-gray-500">
          <icon name="cash"/>
          <span>Earn</span>
        </nuxt-link>
        <client-only>
